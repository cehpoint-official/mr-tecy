                    ...
                    <CardFooter className="flex flex-col items-center gap-3 pb-6">
                        {mode === "customer" ? (
                            ...
                            <>
                                <p className="text-sm text-slate-500">
                                    Not a partner yet?{" "}
                                    <Link href="/partner/apply" className={`font-semibold ${colors.link} hover:underline transition-all`}>
                                        Apply now
                                    </Link>
                                </p>
                                <div className="relative w-full">
                                    ...
                                    <div className="relative flex justify-center text-xs uppercase">
                                        <span className="bg-white px-2 text-slate-500 font-medium">Customer Login</span>
                                    </div>
                                </div>
                                <Link href="/login" className="w-full">
                                    <Button
                                        variant="outline"
                                        className={`w-full ${colors.border} font-semibold py-5 rounded-xl transition-all active:scale-[0.98]`}
                                    >
